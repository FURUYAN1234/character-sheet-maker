...
![Version](https://img.shields.io/badge/version-1.3.8-4f46e5)
...
The current public line is **v1.3.8**. This version is a browser-based React/Vite app with a strict session-only API-key boundary, dual Gemini/OpenAI routing, A/B comparison, parameter locks, 1024x1536 canvas normalization, and provenance watermarking.

現行公開系統は **v1.3.8** です。ブラウザ上で動作する React/Vite アプリで、セッション限定APIキー、Gemini/OpenAIの切り替え、A/B比較、項目ロック、1024x1536キャンバス正規化、来歴ウォーターマークを備えています。

| Area / 領域 | Current behavior / 現行挙動 |
|---|---|
| App version / バージョン | `1.3.8`, displayed in the API gate, header, footer, and watermark. |
...
* File type: PNG
* Watermark: `Generated by Super FURU AI Character Sheet v1.3.8`
